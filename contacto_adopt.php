...
<head>
    ...
    <title>Formato de adopción</title>
...
<section class="page-section">
    <main class="container">
        ...
        <form onsubmit="return validarFormulario2()" id="FormLogin" name="FormLogin" method="POST">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <p style="color: #cf964d;"><label for="animal">¿Qué quieres adoptar?</label></p>
                    <label style="color: black;">
                        <input type="radio" id="amimal" name="animal" value="perro" required> Perro
                    </label>
                    <label style="color: black;">
                        <input type="radio" id="amimal" name="animal" value="gato" required> Gato
                    </label>
                    <div class="form-group">
                        <p style="color: #cf964d;"><label for="nombre_mascota">A cual mascota quieres adoptar</label></p>
                        <input type="text" class="form-control" id="nombre_mascota" name ="nombre_mascota" placeholder="Nombre de la mascota" required>
                    </div>
                    <div class="form-group">
                        <p style="color: #cf964d;"><label for="motivo">¿Por qué quieres adoptar?</label></p>

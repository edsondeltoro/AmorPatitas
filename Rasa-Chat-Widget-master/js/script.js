$(function() {
  ...
  function sayToBot(message) {
    ...
    $.ajax({
      url: 'https://b1e9-2806-2f0-53e0-2a36-8419-9866-b8d6-d3c.ngrok-free.app/webhooks/rest/webhook',
      type: 'POST',
      ...
      error: function (errorMessage) {
        msg="Disculpa… eso no lo entendí, déjame saber si necesitas alguna otra cosa.";

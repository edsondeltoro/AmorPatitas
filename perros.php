<?php
include 'db.php';
$sql = "SELECT image, name, id FROM perros";
...
<section class="page-section about-heading">
    ...
    <div class="gallery">
        ...
        while ($row = $result->fetch_assoc()) {
            echo '<img src="' . $row['image'] . '" alt="Perrito en adopción." id="' . $id_dog . '" data-text="' . $row['name'] . '" onclick="openLightbox(' . $id_dog . ')">';
            $id_dog++;
        }
    ...
    <div id="lightbox" class="lightbox">
        ...
        <span class="prev" onclick="changeImage(-1, <?php echo $id_dog; ?>)">&#10094;</span>
        <span class="next" onclick="changeImage(1, <?php echo $id_dog; ?>)">&#10095;</span>
    </div>
